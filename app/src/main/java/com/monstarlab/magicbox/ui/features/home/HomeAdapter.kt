...
class HomeAdapter(private val context: Context, private val items: ArrayList<Movie>): RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
     ...
     */
    fun insertNewItems(movies: ArrayList<Movie>) {
        items.addAll(movies)
    }

    class ViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        val cover = view.findViewById<AppCompatImageView>(R.id.movieCover)
    }
